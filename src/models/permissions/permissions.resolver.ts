...
export class PermissionsResolver {
  ...
  @AllowAuthenticated()
  @Mutation(() => Permission)
  createPermission(@Args('createPermissionInput') args: CreatePermissionInput, @GetUser() user: GetUserType) {
  ...
  @AllowAuthenticated()
  @Mutation(() => Permission)
  async updatePermission(@Args('updatePermissionInput') args: UpdatePermissionInput, @GetUser() user: GetUserType) {
    const permission = await this.prisma.permission.findUnique({ where: { id: args.id } })
  ...
  @AllowAuthenticated()
  @Mutation(() => Permission)
  async removePermission(@Args() args: FindUniquePermissionArgs, @GetUser() user: GetUserType) {
