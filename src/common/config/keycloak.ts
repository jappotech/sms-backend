...
export const keycloakConfig = {
  ...
  loginUrl:
    `${process.env.KEYCLOAK_URL}/auth/realms/sms-backend/protocol/openid-connect/auth`,
  logoutUrl:
    `${process.env.KEYCLOAK_URL}/auth/realms/sms-backend/protocol/openid-connect/logout`,
  tokenUrl:
    `${process.env.KEYCLOAK_URL}/auth/realms/sms-backend/protocol/openid-connect/token`,
